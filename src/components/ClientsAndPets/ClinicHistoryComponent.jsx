...
import { Grid, IconButton, Typography, Button, Menu, MenuItem, TextField, Divider, Dialog } from '@material-ui/core';
...
export default function ClinicHistoryComponent() {
    ...
    return (
        <>
            ...
            <Grid container className={classes.newConsultation} spacing={2} justify='center'>
                <Grid item xl={2}>
                    <Button
