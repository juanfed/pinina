...
import { Grid, Box, Card, CardActionArea, CardActions, CardContent, Button, Typography } from '@material-ui/core';
                    ...
                    <Grid item xl={ 12 } sm={ 12} md={ 12 } xs={ 12 }>
                        <Card className={ clsx(classes.media, 'shadow') }>
                            ...
                            <CardContent className="text-center">
                                ...
                                <Skeleton className="mx-auto mt-2" variant="rect" width={ 700 } height={ 250 } />
                            </CardContent>
                            <CardActions>
